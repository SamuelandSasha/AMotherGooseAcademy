...
function startConversation() {
    fetch('https://chatbot-for-a-mother-goose-samuelsicking.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
  ...
  //  sendInputToGAS3(userMessage, true);
    ...
    fetch('https://chatbot-for-a-mother-goose-samuelsicking.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbwkASMSIE3VXKhajid4JVvLzmQhYULnfCNxSZcFH4kMHf1__tE86pca73nkMVLr785q/exec';
